...
namespace Glass.Mapper.Sc.CastleWindsor.Tests.Pipelines.ObjectConstruction
{
    [TestFixture]
    public class WindsorConstructionFixture
    {
        ...
        public void Execute_RequestInstanceOfClass_ReturnsInstance()
        {
            ...
            var args = new ObjectConstructionArgs(context, typeCreationContext, new []{typeConfig}, service);
        ...
        public void Execute_ResultAlreadySet_NoInstanceCreated()
        {
            ...
            var args = new ObjectConstructionArgs(context, null, new[] { typeConfig }, null);
        ...
        public void Execute_RequestInstanceOfInterface_ReturnsNullInterfaceNotSupported()
        {
            ...
            var args = new ObjectConstructionArgs(context, typeCreationContext, new[] { typeConfig }, null);
