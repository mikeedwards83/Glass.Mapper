...
{
    //[TestFixture]
    //public class ConstructionCreatedMonitorTaskFixture
    //{
    //    [Test]
    //    public void ConstructionCreated_CounterIncrementedBy()
    //    {
    //        //Arrange
    ...
    //        })
    //        {
    //            ThreadData.SetValue(ConstructionCreatedMonitorTask.CacheMissKey, 0);
    ...
    //            //Assert
    //            var counter = ConstructionCreatedMonitorTask.GetCounter();
    ...
    //    [Test]
    //    public void ConstructionCreated_WithChildren_IncrementsForEachChild()
    //    {
    //        //Arrange
    //        string path = "/sitecore/content/target";
    ...
    //    [Test]
    //    public void ConstructionCreated_CachedItem_Increments()
    //    {
    //        //Arrange
    //        string path = "/sitecore/content/target";
    ...
    //    [Test]
    //    public void ConstructionCreated_CachedItemWithChildren_SingleIncrements()
    //    {
    //        //Arrange
    //        string path = "/sitecore/content/target";
    ...
    //            var counterFirst = ConstructionCreatedMonitorTask.GetCounter();
    ...
    //            var counterSecond = ConstructionCreatedMonitorTask.GetCounter();
    //            //Assert

    //            Assert.AreEqual(3, counterFirst);
    //            Assert.AreEqual(2, childCount1);

    //            Assert.AreEqual(0, counterSecond);
