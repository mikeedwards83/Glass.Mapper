...
namespace Glass.Mapper.Sc.Integration
{
    ...
    public class GlassHtmlFixture
    {
        ...
        public void RenderLink_LinkContainsQueryString_Issue116()
        {
            ...
            string fieldValue = "<link text='' linktype='internal' class='' title=''  querystring='foo=bar' id='{0}' />".Formatted(item.ID.Guid.ToString("B"));
            string expected = "<a href='/en/sitecore/content/Tests/GlassHtml/MakeEditable/Target.aspx?foo=bar' >Target</a>";
