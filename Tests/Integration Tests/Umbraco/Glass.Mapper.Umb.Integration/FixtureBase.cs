    ...
    public abstract class FixtureBase
    {
        ...
        public virtual void Initialize()
        {
          ...
          //   Resolution.Freeze();
            ...
            var applicationContextType = typeof(ApplicationContext);
            ApplicationContext = (ApplicationContext)Activator.CreateInstance(applicationContextType, true);
            applicationContextType.GetProperty("IsReady").SetValue(ApplicationContext, true, null);
        ...
        public virtual void TearDown()
        {
            ...
            applicationContextType.GetProperty("Current").SetValue(ApplicationContext, null, null);
       //     Resolution.IsFrozen = false;
        ...
        protected FakeHttpContextFactory GetHttpContextFactory(string url, RouteData routeData = null)
        {
            ...
            var context = factory.HttpContext;
            var stateHelper = Activator.CreateInstance(typeof(StateHelper));
          //  typeof(StateHelper).GetProperty("HttpContext").SetValue(stateHelper, context, null);
        ...
        {
            var ctx = (UmbracoContext)Activator.CreateInstance(typeof(UmbracoContext), GetHttpContextFactory(url, routeData).HttpContext, ApplicationContext, new FakeRoutesCache());
...
<root id=""-1"">
	...
	<CustomDocument id=""1172"" parentID=""-1"" level=""1"" writerID=""0"" creatorID=""0"" nodeType=""1234"" template=""" + templateId + @""" sortOrder=""2"" createDate=""2012-07-16T15:26:59"" updateDate=""2012-07-18T14:23:35"" nodeName=""Test"" urlName=""test-page"" writerName=""admin"" creatorName=""admin"" path=""-1,1172"" isDoc="""" />
        ...
        {
            var getXmlDelegate = new Func<XmlDocument>(() =>
                {
            ...
            typeof(UmbracoContext).GetProperty("GetXmlDelegate").SetValue(umbracoContext, getXmlDelegate, null);
        }
    }
}
