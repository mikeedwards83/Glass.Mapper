    ...
    public abstract class FixtureBase
    {
        ...
        public virtual void Initialize()
        {
           ...
           // ApplicationContext = new ApplicationContext() {IsReady = true};
            ...
            _httpContextFactory = GetHttpContextFactory("~/Home");
            //ensure the StateHelper is using our custom context
            HttpContext.Current = _httpContextFactory.HttpContext.ApplicationInstance.Context;
        }
        ...
        public virtual void TearDown()
        {
         ...
         //   ApplicationContext.Current.ApplicationCache.ClearAllCache();
          ...
          //  MethodInfo methodInfo = typeof(UmbracoSettings).GetMethod("ResetSetters", BindingFlags.Static | BindingFlags.NonPublic);
            //methodInfo.in(null, new object[]{});
