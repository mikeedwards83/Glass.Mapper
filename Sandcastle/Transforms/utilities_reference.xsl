		...
		<html>
			...
			<body onload="OnLoad('{$defaultLanguage}')">
				...
				<div class="pageHeader" id="PageHeader">
					<a href="/"><h1>Glass Assembly Documentation </h1></a>
					<ul class="menu">
						<li>
							<a href="http://glass.lu">Main Website</a>
						</li>
						<li>
							<a href="http://www.glass.lu/Mapper/Sc/Tutorials">Tutorials</a>
						</li>
						<li>
							<a href="http://www.glass.lu/Mapper/Sc/Documentation">Documentation</a>
						</li>
					</ul>
				</div>
				<div class="pageBody">
