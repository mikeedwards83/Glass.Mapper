...
{
    /// <summary>
    /// UmbracoPropertyDoubleMapper
    /// </summary>
    public class UmbracoPropertyDoubleMapper : AbstractUmbracoPropertyMapper
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UmbracoPropertyDoubleMapper"/> class.
        /// </summary>
        public UmbracoPropertyDoubleMapper()
            : base(typeof(double))
        {
        }
        ...
        {
            return propertyValue is double ? (double)propertyValue : 0;
        }
    }
}
