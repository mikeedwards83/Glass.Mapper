...
namespace Glass.Mapper
{
    ...
    /// AbstractService
    /// </summary>
    public abstract class AbstractService2 : IAbstractService
    {
        ...
        protected AbstractService2(string contextName)
        ...
        protected AbstractService2(Context glassContext)
        {
