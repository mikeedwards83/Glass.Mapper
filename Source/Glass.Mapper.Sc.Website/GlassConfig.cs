...
namespace Glass.Mapper.Sc.Website
{
    public class GlassConfig : GlassCastleConfigBase
    {
        ...
        public override IEnumerable<ComponentRegistration<ITypeResolverTask>> TypeResolverTasks(string contextName)
        {
            ...
            return new[]
                    {
                        Component.For<ITypeResolverTask>().ImplementedBy<TypeStandardResolverTask>(),
                    };
        }

        public override IEnumerable<ComponentRegistration<ITypeResolverTask>> ConfigurationResolverTasks(string contextName)
        {
            //****** Object Construction Tasks ******//
        ...
        public override IEnumerable<ComponentRegistration<IObjectConstructionTask>> ObjectContructionTasks(string contextName)
        {
            ...
            return
                new[]
                    {
                        Component.For<IObjectConstructionTask>().ImplementedBy<CreateConcreteTask>(),
                        Component.For<IObjectConstructionTask>().ImplementedBy<CreateInterfaceTask>(),
                    };
        }
