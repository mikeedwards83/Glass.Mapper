...
namespace Glass.Mapper.Sc.Web.WebForms.Ui
{
    ...
    public class GlassUserControl<T> : AbstractGlassUserControl where T : class
    {
        ...
        public GlassUserControl(IWebFormsContext webContext):base(webContext)
        {
        }
        ...
        /// </summary>
        public GlassUserControl() : this(new WebFormsContext(new SitecoreService(Sitecore.Context.Database)))
        {
        }
