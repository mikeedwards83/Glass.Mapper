...
namespace Glass.Mapper.Sc
{
    ...
    /// </summary>
    public class SitecoreService2 : AbstractService2, ISitecoreService
    {
        ...
        public SitecoreService2(Database database, string contextName = "Default")
        ...
        /// <param name="contextName">Name of the context.</param>
        public SitecoreService2(string databaseName, string contextName = "Default")
        ...
        public SitecoreService2(string databaseName, Context context)
        ...
        /// <param name="database">The database.</param>
        /// <param name="context">The context.</param>
        public SitecoreService2(Database database, Context context)
