...
{
    public class SitecoreCacheAlwaysOnCheckTask : CacheAlwaysOnCheckTask
    {
        public SitecoreCacheAlwaysOnCheckTask(CacheFactory cacheFactory, ICacheKeyGenerator cacheKeyGenerator)
